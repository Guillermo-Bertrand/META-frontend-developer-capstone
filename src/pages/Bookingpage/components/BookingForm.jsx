            ...
            <section>
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                    <div className="inputs-container">
                        ...
                        <SelectComponent name="reservationTime" label="Choose time" options={[{ value: '17:00', text: '17:00' }, { value: '18:00', text: '18:00' }]} register={register} errors={errors} required={true} />
                    ...
                    <button type="submit">Hacer reservación</button>
                </form>
            </section>
        </>
    );
